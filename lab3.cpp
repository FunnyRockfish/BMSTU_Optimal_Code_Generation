...
llvm::Value *AssignAST::codegen(){
    ...
    llvm::Value *CurVar = Builder.CreateLoad(llvm::Type::getInt32Ty(MainContext), Alloca);
...
llvm::Value *VariableExprAST::codegen() {
    ...
    return Builder.CreateLoad(llvm::Type::getInt32Ty(MainContext), V, Name);
...
llvm::Value *IfExprAST::codegen() {
    ...
    MainFunction->insert(MainFunction->end(), ElseBB);
    ...
    MainFunction->insert(MainFunction->end(), MergeBB);
...
static AllocaInst *CreateEntryBlockAlloca(Function *TheFunction,
    ...
    return TmpB.CreateAlloca(Type::getInt32Ty(MainContext), nullptr, VarName);
